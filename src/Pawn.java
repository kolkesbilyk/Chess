...
public class Pawn implements ChessFigure{
    int xp;
    int yp;
    boolean isWhite;
    ...
    public Pawn(int xp, int yp, boolean isWhite, ArrayList<ChessFigure> chessFigures) {
        this.xp = xp;
        this.yp = yp;
    ...
    public Image getImageFigure() {
        return isWhite == true? (Image) Items.PAWNWHITE.image : (Image) Items.PAWNBLACK.image;
    }
