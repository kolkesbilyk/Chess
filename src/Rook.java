...
public class Rook implements ChessFigure{
    ...
    public Rook(int xp, int yp, boolean isWhite, ArrayList<ChessFigure> chessFigures) {
        this.xp = xp;
        this.yp = yp;
    ...
    public Image getImageFigure() {
        return isWhite == true? (Image) Items.ROOKWHITE.image : (Image) Items.ROOKBLACK.image;
    }
