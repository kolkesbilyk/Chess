...
public class Queen implements ChessFigure{
    int xp;
    int yp;
    boolean isWhite;
    ...
    public Queen(int xp, int yp, boolean isWhite, ArrayList<ChessFigure> chessFigures) {
        this.xp = xp;
        this.yp = yp;
    ...
    public Image getImageFigure() {
        return isWhite == true? (Image) Items.QUEENWHITE.image : (Image) Items.QUEENBLACK.image;
    }
