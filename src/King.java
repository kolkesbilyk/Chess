...
public class King implements ChessFigure{
    int xp;
    int yp;
    boolean isWhite;
    ...
    public King(int xp, int yp, boolean isWhite, ArrayList<ChessFigure> chessFigures) {
        this.xp = xp;
        this.yp = yp;
    ...
    public Image getImageFigure() {
        return isWhite == true? (Image) Items.KINGWHITE.image : (Image) Items.KINGBLACK.image;
    }
